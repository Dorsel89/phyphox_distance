...
{
    if (params->handle == PhyphoxBLE::configCharacteristic.getValueHandle() ) {
...
{	
	...
	ble::AdvertisingParameters adv_parameters(ble::advertising_type_t::CONNECTABLE_UNDIRECTED, ble::adv_interval_t(ble::millisecond_t(500)));
